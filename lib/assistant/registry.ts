...
export type EditableFieldType = "text" | "richText" | "color" | "font";
...
export const EDITABLE_FIELDS: Record<EditableFieldId, EditableField> = {
  ...
  "home.heroCopy": { id: "home.heroCopy", label: "Homepage introduction", page: "Homepage", type: "richText", maxLength: 240, description: "The short homepage introduction." },
  ...
  "about.intro": { id: "about.intro", label: "About introduction", page: "About", type: "richText", maxLength: 1200, description: "The opening About page paragraph. Preserve the person's factual meaning." },
  "about.body": { id: "about.body", label: "About page body", page: "About", type: "richText", maxLength: 5000, description: "The remaining About page paragraphs, separated by blank lines." },
  ...
  "contact.representation": { id: "contact.representation", label: "Contact representation", page: "Contact", type: "richText", maxLength: 500, description: "The representation and theatrical representation note, separated by blank lines." },
  ...
  "resume.training": { id: "resume.training", label: "Training", page: "Resume", type: "richText", maxLength: 3000, description: "Training credits, one per line as Institution | Detail." },
  "resume.skills": { id: "resume.skills", label: "Special skills", page: "Resume", type: "richText", maxLength: 1200, description: "The special skills paragraph." },
  ...
  "theme.background": { id: "theme.background", label: "Background", page: "Sitewide", type: "color", maxLength: 7, description: "The main page background." },
  "theme.foreground": { id: "theme.foreground", label: "Foreground / text", page: "Sitewide", type: "color", maxLength: 7, description: "The primary text and dark surface colour." },
  "theme.primary": { id: "theme.primary", label: "Primary accent", page: "Sitewide", type: "color", maxLength: 7, description: "The main highlight and active-state colour." },
  "theme.secondary": { id: "theme.secondary", label: "Secondary accent", page: "Sitewide", type: "color", maxLength: 7, description: "A supporting accent used in art-directed moments." },
  "theme.highlight": { id: "theme.highlight", label: "Highlight", page: "Sitewide", type: "color", maxLength: 7, description: "The accessible focus and link highlight colour." },
...
export const DEFAULT_EDITABLE_CONTENT: EditableContent = {
  ...
  theme: { background: "#ffffff", foreground: "#10100c", primary: "#e8ff2a", secondary: "#ff3a22", highlight: "#006cff", headingFont: "Oswald" },
...
export function normalizeContent(input: unknown): EditableContent {
  ...
  const legacyTheme = source.theme as (Partial<EditableContent["theme"]> & { paper?: string; ink?: string; acid?: string; blue?: string; verm?: string; accentColor?: string }) | undefined;
  const theme = {
    background: legacyTheme?.background ?? legacyTheme?.paper ?? DEFAULT_EDITABLE_CONTENT.theme.background,
    foreground: legacyTheme?.foreground ?? legacyTheme?.ink ?? DEFAULT_EDITABLE_CONTENT.theme.foreground,
    primary: legacyTheme?.primary ?? legacyTheme?.acid ?? legacyTheme?.accentColor ?? DEFAULT_EDITABLE_CONTENT.theme.primary,
    secondary: legacyTheme?.secondary ?? legacyTheme?.verm ?? DEFAULT_EDITABLE_CONTENT.theme.secondary,
    highlight: legacyTheme?.highlight ?? legacyTheme?.blue ?? DEFAULT_EDITABLE_CONTENT.theme.highlight,
    headingFont: legacyTheme?.headingFont ?? DEFAULT_EDITABLE_CONTENT.theme.headingFont,
  };
  return {
