...
const pages: Page[] = [
  ...
  { label: "Resume", path: "/resume", fields: ["pages.resumeHeading", "resume.intro", "resume.theater", "resume.stagedReadings", "resume.film", "resume.training", "resume.skills"], media: ["resume.primaryImage", "resume.secondaryImage"] },
